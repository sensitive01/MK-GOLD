...
// mock
import { deletePayprocessById, getPayprocess } from '../../apis/hr/payprocess';
...
export default function Payprocess() {
  ...
  return (
    <>
      <Helmet>
        <title> Payprocess | MK Gold </title>
      </Helmet>
      ...
      {toggleContainer === true && toggleContainerType === 'update' && (
        <Container maxWidth="xl">
          ...
          <UpdatePayprocess setToggleContainer={setToggleContainer} id={openId} setNotify={setNotify} />
        </Container>
      )}
