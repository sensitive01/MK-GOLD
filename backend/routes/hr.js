...
hrRouter.get("/branch/get-next-id", branch.getNextBranchId);
...
hrRouter.get("/employee/get-next-id", employee.getNextEmployeeId);
...
hrRouter.get("/expense/get", expense.find);
hrRouter.post("/expense/get", expense.find);
