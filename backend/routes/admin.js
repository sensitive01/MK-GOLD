...
const quotation = require("../controllers/admin/quotation");
const allowance = require("../controllers/admin/allowance");
const lead = require("../controllers/admin/lead");
...
adminRouter.get("/allowance/get", allowance.find);
...
adminRouter.get("/branch/get-next-id", branch.getNextBranchId);
...
adminRouter.get("/employee/get-next-id", employee.getNextEmployeeId);
...
adminRouter.post("/sales/verify-finance-payment/:id/:paymentId", sales.verifyFinancePayment);
