...
const employee = require("../controllers/accounts/employee");
...
accountsRouter.get("/employee/get", employee.find);
accountsRouter.post("/employee/get", employee.find);
accountsRouter.get("/employee/get/:id", employee.findById);
...
accountsRouter.get("/leave/get", leave.find);
accountsRouter.post("/leave/get", leave.find);
accountsRouter.get("/leave/get/:id", leave.findById);
accountsRouter.post("/leave/create", leave.create);
accountsRouter.post("/leave/update/:id", leave.update);
accountsRouter.post("/leave/delete/:id", leave.remove);
